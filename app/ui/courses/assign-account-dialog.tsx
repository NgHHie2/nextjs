...
export default function AssignAccountDialog({
  ...
  const handleSearch = async () => {
    ...
    try {
      const accounts = await searchAccountByCccd(searchQuery.trim());
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                id="searchQuery"
                placeholder="Enter username or CCCD"
                value={searchQuery}
          ...
          <div className="space-y-2">
            ...
            <div className="border rounded-lg bg-muted/20 h-24 overflow-y-auto">
              <Table>
                <TableHeader>
                  <TableRow>
